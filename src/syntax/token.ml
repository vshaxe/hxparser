...
let s_xsymbol x =
	...
	| X (N x) ->
		...
		| N_option_type_hint_ -> "type_hint?"
		| N_option_assignment_ -> "assignment?"
		| N_option_underlying_type_ -> "underlying_type?"
		| N_option_guard_ -> "guard?"
		| N_option_QUESTIONMARK_ -> "questionmark?"
		| N_option_dollar_ident_ -> "dollar_ident?"
		| N_option_SEMICOLON_ -> "semicolon?"
		| N_option_pos_dollar_ident__ -> "ident?"
		| N_lpoption_type_hint_ -> "type_hint?"
		| N_lpoption_assignment_ -> "assignment?"
		| N_lpoption_else_expr_ -> "else?"
		| N_loption_path_ -> "path?"
		| N_loption_separated_nonempty_list_COMMA_expr__ -> ""
		| N_loption_separated_nonempty_list_COMMA_function_argument__ -> ""
		(* lists *)
		| N_array_elements -> "#list"
		| N_array_elements_next -> "#list"
		| N_anonymous_type_field_next -> "#list"
		| N_object_fields -> "#list"
		| N_object_fields_next -> "#list"
		| N_var_declarations -> "#list"
		| N_var_declarations_next -> "#list"
		| N_path_with_pos -> ""
		| N_lplist_pos_DOT_IDENT__ -> "#list"
		| N_lplist_DOT_IDENT_ -> "#list"
		| N_lplist_catch_ -> "#list"
		| N_list_modifier_ -> "#list"
		| N_list_common_flags_ -> "#list"
		| N_list_case_ -> "#list"
		| N_list_block_element_ -> "#list"
		| N_list_abstract_relations_ -> "#list"
		| N_list_decl_ -> "#list"
		| N_list_class_field_ -> "#list"
		| N_list_metadata_ -> "#list"
		| N_list_class_relations_ -> "#list"
		| N_nonempty_list_structural_extension_ -> "#list"
		| N_nonempty_list_block_element_ -> "#list"
		| N_nonempty_list_class_field_ -> "#list"
		| N_separated_nonempty_list_COMMA_expr_ -> "#list"
		| N_separated_nonempty_list_COMMA_type_path_parameter_ -> "#list"
		| N_separated_nonempty_list_COMMA_type_decl_parameter_ -> "#list"
